...
Обходим вершины в цикле while. Каждая вершина посещается максимум по одному разу. 
Сложность = количество вершин * количество ребер. Количество ребер в данном графе ~ 2 * WIDTH * HEIGHT. Но так как каждое просматривается дважды при обходе, то количество ребер ~ 4 * WIDTH * HEIGHT. 
